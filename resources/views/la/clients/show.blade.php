		...
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<p class="desc">Client Information</p>
				</div>
			</div>
		</div>
		<div class="col-md-3">
			<div class="dats1"><div class="label2">User</div></div>
			<div class="dats1"><i class="fa fa-envelope-o"></i> {{ $client->client_email }}</div>
			<div class="dats1"><i class="fa fa-map-marker"></i> {{ $client->client_location }}</div>
		</div>
		<div class="col-md-4">
			<!--
			<div class="teamview">
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'client_name')
						@la_display($module, 'client_email')
						@la_display($module, 'phone')
						@la_display($module, 'client_location')
						@la_display($module, 'client_website')
					</div>
				</div>
			</div>
		</div>
